function [x_k1,x_k1_dot,e_o_E,u_in,rot_vel_ref] = NDI_TScale_Euler(att,rot_vel,att_ref,rot_vel_ref_0,T_d,J,n,dt,Kp_o,Kp_i)
...
v_o = Kp_o.*e_o_E; % NOTE: d(theta_ref)/dt = 0
